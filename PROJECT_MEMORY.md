...
- **2026-07-23 deployment evidence:** commit `5a28a33` was pushed and deployed through Coolify deployment `rokw88g4wck8k4so0o80444s`; the running frontend container is healthy on image `r0c44ok0cskc800gs0c8o8wk:5a28a33b84b3c2f6ebebdc4402a0bb0bee92d45f`. Post-deploy `npm run production:smoke` passed 7/7. The server cron wrapper dry-run returned `action=would_enqueue` for `brief-fpv-drone-wont-arm-troubleshooting`, proving the new backlog selector is live without spending Dify budget.
