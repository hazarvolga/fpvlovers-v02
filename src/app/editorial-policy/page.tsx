...
export default function EditorialPolicyPage() {
  ...
  const scoringWeights = [
    ...
    { category: 'Software & Ease of Tuning', weight: '15%', desc: 'EdgeTX/Betaflight configuration ease, firmware flashing reliability, and configuration clarity.' },
    ...
    <div className="fpv-public-shell mx-auto max-w-4xl px-4 py-12 pt-28 font-sans text-zinc-300 sm:px-6 lg:px-8">
      ...
      <div className="fpv-public-panel relative mb-10 overflow-hidden rounded-xl p-8 shadow-2xl md:p-12">
        ...
        <div className="relative z-10">
          <FileText className="mb-6 h-12 w-12 text-[#FF5C00]" />
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-zinc-100 mb-4 uppercase">
            Editorial <span className="text-[#FF5C00]">Policy</span>
          </h1>
          <p className="fpv-kicker">
            Review standards and disclosure rules
          </p>
      ...
      <div className="space-y-12 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold uppercase text-zinc-100 tracking-wider flex items-center gap-2">
            <Cpu className="w-5 h-5 text-[#FF5C00]" /> 2. AI-Assisted Workflows & Human Verification
          </h2>
          <p className="text-sm text-zinc-400">
          ...
          <div className="p-4 bg-zinc-950/80 border border-white/5 rounded-lg space-y-3">
            <div className="flex items-center gap-2 text-xs font-mono text-[#FF5C00] uppercase font-black">
              ...
              <tbody className="divide-y divide-white/5">
                {scoringWeights.map((w, idx) => (
                  <tr key={idx} className="hover:bg-white/5">
                    ...
                    <td className="p-4 text-[#FF5C00] font-black">{w.weight}</td>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold uppercase text-zinc-100 tracking-wider flex items-center gap-2">
            <HelpCircle className="w-5 h-5 text-[#FF5C00]" /> 5. Affiliate Disclosure Principles
          </h2>
          <p className="text-sm text-zinc-400">
            Some retailer links may become affiliate links. Commercial links and sponsored placements must be labeled without changing the editorial verdict. Read the full <Link href="/disclosure" className="text-[#FF5C00] hover:underline font-bold">Affiliate Disclosure</Link> and <Link href="/advertise" className="text-[#FF5C00] hover:underline font-bold">Advertising Policy</Link>.
          </p>
        </section>
      </div>
