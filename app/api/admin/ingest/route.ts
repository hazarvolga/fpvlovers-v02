...
const API_KEY = process.env.DIFY_API_KEY || 'dataset-57xGhkCvaQKR2YoSljA94NVu';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const headers = { Authorization: `Bearer ${API_KEY}`, 'Content-Type': 'application/json' as const };
