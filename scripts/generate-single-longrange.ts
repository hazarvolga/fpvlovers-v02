...
async function main() {
  ...
  console.log(`Starting production RAG-grounded FPV Long Range Specialization content ingestion...`);
  ...
  console.log(`\n======================================================`);
  console.log(`[DIFY RUNNER] Specialization Content Ingestion Complete!`);
